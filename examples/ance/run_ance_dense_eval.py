...
from modeling_ance import ANCEEncoder, ANCETokenizerFast
...
def main():
    ...
    tokenizer = ANCETokenizerFast.from_pretrained(model_args.model_name_or_path)
    model = ANCEEncoder.from_pretrained(model_args.model_name_or_path)
    ###
