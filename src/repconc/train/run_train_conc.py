...
def load_validation_set(corpus_path, query_path, qrel_path, sep_token):
    from repconc.utils.eval_utils import load_corpus, load_queries
    import pytrec_eval
    with open(qrel_path, 'r') as f_qrel:
        qrel = pytrec_eval.parse_qrel(f_qrel)
    corpus = load_corpus(corpus_path, sep_token=sep_token)
...
def main():
    ...
    repconc = RepCONC.from_pretrained(
        model_args.model_name_or_path, 
