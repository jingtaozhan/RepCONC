...
class ModelArguments:
    ...
    index_input_dir: str = field()


def load_validation_set(query_path, qrel_path):
    from repconc.utils.eval_utils import load_queries
    import pytrec_eval
...
def main():
    ...
    repconc = RepCONC.from_pretrained(model_args.model_name_or_path, use_constraint=False, sk_epsilon=None, sk_iters=None)
